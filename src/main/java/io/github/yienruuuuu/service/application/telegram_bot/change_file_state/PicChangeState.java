...
import io.github.yienruuuuu.service.application.telegram_bot.divination_state.DivinationBaseState;
 ...
 */
@Component
public class PicChangeState extends ChangeFileBaseState implements ChangeFileBotState {

    @Autowired
    public PicChangeState(TelegramBotClient telegramBotClient) {
